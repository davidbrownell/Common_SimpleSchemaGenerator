...
# ----------------------------------------------------------------------
_elements = ParseStrings( { "" : SIMPLE_SCHEMA, },
                          InternalPlugin(),
...
class TestBase(unittest.TestCase):
    ...
    def test_TypeInfo(self):
        ...
        self.assertEqual(self._element.TypeInfo, ClassTypeInfo({ "a" : StringTypeInfo(arity='*'), }, require_exact_match=True, arity=Arity(1,1)))
        self.assertEqual(self._element.Children[0].TypeInfo, StringTypeInfo(arity='*'))
...
class TestDerived(unittest.TestCase):
    ...
    def test_ElementInfo(self):
        ...
        self.assertEqual([ child.Name for child in self._element.Children ], [ "b", "c", "v1", "v2", "v3", "c_ref0", "c_ref1", "c_ref2", "c_ref25", "c_ref3", "c_ref4", "test_derived_ref1", "test_derived_ref2", "test_derived_ref3", "test_derived_ref4", "test_derived_ref5", ])
    ...
    def test_C(self):
        ...
        self.assertTrue(isinstance(element, FundamentalElement))
        self.assertEqual(element.TypeInfo, StringTypeInfo(min_length=12, arity='*'))
    ...
    def test_V1(self):
        ...
        self.assertEqual(element.TypeInfo, AnyOfTypeInfo([ BoolTypeInfo(), StringTypeInfo(), IntTypeInfo(min=20), ]))
    ...
    def test_V2(self):
        ...
        self.assertEqual(element.TypeInfo, AnyOfTypeInfo([ BoolTypeInfo(), BoolTypeInfo(), StringTypeInfo(), IntTypeInfo(min=20), ]))
    ...
    def test_V3(self):
        ...
        self.assertTrue(isinstance(element, VariantElement))
        self.assertTrue(isinstance(element.Variations[1], ReferenceElement))
        self.assertEqual(element.TypeInfo, AnyOfTypeInfo([ UriTypeInfo(), BoolTypeInfo(), BoolTypeInfo(), StringTypeInfo(), IntTypeInfo(min=20), FilenameTypeInfo(ensure_exists=True), ]))
    ...
    def test_CRef1(self):
        ...
        self.assertTrue(isinstance(element, FundamentalElement))
        self.assertEqual(element.TypeInfo, StringTypeInfo(min_length=12, max_length=20, arity='*'))
    ...
    def test_CRef2(self):
        ...
        self.assertTrue(isinstance(element, FundamentalElement))
        self.assertEqual(element.TypeInfo, StringTypeInfo(min_length=12, arity=Arity(20, 20)))
    ...
    def test_CRef25(self):
        ...
        self.assertTrue(isinstance(element, FundamentalElement))
        self.assertEqual(element.TypeInfo, StringTypeInfo(min_length=12, max_length=20, arity=Arity(20, 20)))
    ...
    def test_CRef3(self):
        ...
        self.assertEqual(element.TypeInfo, ListTypeInfo(StringTypeInfo(min_length=12, arity='*'), arity=Arity(5, 5)))
    ...
    def test_CRef4(self):
        ...
        self.assertTrue(isinstance(element, ListElement))
        self.assertEqual(element.TypeInfo, ListTypeInfo(ListTypeInfo(StringTypeInfo(min_length=12, arity='*'), arity=Arity(5, 5)), arity=Arity(10, 10)))
    ...
    # ----------------------------------------------------------------------
    # ----------------------------------------------------------------------
    def _VerifyTestDerived(self, type_info, verify_derived_refs=True):
        self.assertTrue(isinstance(type_info, ClassTypeInfo))
        self.assertEqual(list(six.iterkeys(type_info.Items)), [ "b", "c", "v1", "v2", "v3", "c_ref0", "c_ref1", "c_ref2", "c_ref25", "c_ref3", "c_ref4", "test_derived_ref1", "test_derived_ref2", "test_derived_ref3", "test_derived_ref4", "test_derived_ref5", ])
        self.assertEqual(type_info.Items["b"], BoolTypeInfo())
        self.assertEqual(type_info.Items["c"], StringTypeInfo(min_length=12, arity='*'))
        self.assertEqual(type_info.Items["v1"], AnyOfTypeInfo([ BoolTypeInfo(), StringTypeInfo(), IntTypeInfo(min=20), ]))
        self.assertEqual(type_info.Items["v2"], AnyOfTypeInfo([ BoolTypeInfo(), BoolTypeInfo(), StringTypeInfo(), IntTypeInfo(min=20), ]))
        self.assertEqual(type_info.Items["v3"], AnyOfTypeInfo([ UriTypeInfo(), BoolTypeInfo(), BoolTypeInfo(), StringTypeInfo(), IntTypeInfo(min=20), FilenameTypeInfo(ensure_exists=True), ]))
        self.assertEqual(type_info.Items["c_ref0"], StringTypeInfo(min_length=12, arity='*'))
        self.assertEqual(type_info.Items["c_ref1"], StringTypeInfo(min_length=12, max_length=20, arity='*'))
        self.assertEqual(type_info.Items["c_ref2"], StringTypeInfo(min_length=12, arity=Arity(20, 20)))
        self.assertEqual(type_info.Items["c_ref25"], StringTypeInfo(min_length=12, max_length=20, arity=Arity(20, 20)))
        self.assertEqual(type_info.Items["c_ref3"], ListTypeInfo(StringTypeInfo(min_length=12, arity='*'), arity=Arity(5, 5)))
        self.assertEqual(type_info.Items["c_ref4"], ListTypeInfo(ListTypeInfo(StringTypeInfo(min_length=12, arity='*'), arity=Arity(5, 5)), arity=Arity(10, 10)))
