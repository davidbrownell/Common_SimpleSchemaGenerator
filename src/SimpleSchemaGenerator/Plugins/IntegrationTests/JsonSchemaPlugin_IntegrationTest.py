...
class JsonSchema(unittest.TestCase):
    ...
    def test_AllTypes(self):
        ...
        # Doctor some content so that it mates the strict jsonschema type checking
        for index, guid in enumerate(instance_content["types"]["guid_"]):
            instance_content["types"]["guid_"][index] = "{{{}}}".format(guid)
