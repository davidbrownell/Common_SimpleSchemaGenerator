...
class SimpleSchemaVisitor(ParseTreeVisitor):
    ...
    def visitConfigStatementContent__(
        self,
        ctx: SimpleSchemaParser.ConfigStatementContent__Context,
    ):
        return self.visitChildren(ctx)
    ...
    def visitDeclarationAttributesItems(
        self,
        ctx: SimpleSchemaParser.DeclarationAttributesItemsContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SimpleSchemaParser#declarationAttributesItem__.
    def visitDeclarationAttributesItem__(
        self,
        ctx: SimpleSchemaParser.DeclarationAttributesItem__Context,
    ):
        return self.visitChildren(ctx)
    ...
    def visitExtensionContentStandard__(
        self,
        ctx: SimpleSchemaParser.ExtensionContentStandard__Context,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SimpleSchemaParser#extensionContentPositional.
    def visitExtensionContentPositional(
        self,
        ctx: SimpleSchemaParser.ExtensionContentPositionalContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SimpleSchemaParser#extensionContentKeywords__.
    def visitExtensionContentKeywords__(
        self,
        ctx: SimpleSchemaParser.ExtensionContentKeywords__Context,
    ):
        return self.visitChildren(ctx)
